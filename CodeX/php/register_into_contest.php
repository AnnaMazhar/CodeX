...
<body>
    ...
    <div>
          ...
          <?php 
          $query = "SELECT * FROM contest WHERE NOT EXISTS (SELECT * FROM participations WHERE username = '$participant_username' AND participations.contest_ID = contest.contest_ID) ORDER BY contest_ID";
